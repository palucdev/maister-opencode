...
3. Check `.maister/docs/standards/` exists in the current project. If not, offer to run `/flow-init` first.
...
If `.maister/docs/` doesn't exist, offer to run `/flow-init` first.
