...
**Invoke `maister-docs-operator` subagent** via Task tool (subagent_type: `maister-docs-operator`) with prompt:
...
**Step 1**: Invoke `maister-docs-operator` subagent via Task tool (subagent_type: `maister-docs-operator`) with prompt:
