...
```
User: /maister-copilot/reviews-reality-check .maister/tasks/new-features/2025-11-17-payment-processing/
```

**Example 2**: Verify claimed completion
```
User: /maister-copilot/reviews-reality-check .maister/tasks/bug-fixes/2025-11-17-login-timeout/
```

**Example 3**: Production readiness check
```
User: /maister-copilot/reviews-reality-check .maister/tasks/enhancements/2025-11-17-user-dashboard/ --production
```
