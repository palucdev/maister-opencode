...
**IMPORTANT**: Do NOT write any files to disk. The maister-copilot/init command will use your returned analysis to generate proper documentation in `.maister/docs/`.
