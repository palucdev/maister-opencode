...
Use this structure when generating or updating `.ai-sdlc/docs/INDEX.md`. Scan the actual `.ai-sdlc/docs/` directory to populate sections dynamically — do not hardcode file lists.
...
Located in `.ai-sdlc/docs/standards/[category]/`
